...
// Aviation Control Tower Theme Colors
const COLORS = ['#00d4ff', '#00ff87', '#ffaa00', '#ff4757', '#8b949e']
...
function App() {
  ...
  const getStatusData = () => {
    if (!stats) return []
    return [
      { name: '활성', value: stats.active, color: '#00ff87' },
      { name: '만료', value: stats.expired, color: '#ffaa00' },
      { name: '예정', value: stats.scheduled, color: '#00d4ff' },
    ]
  }
    ...
    <div className="app">
            ...
            <div className="chart-card">
              ...
              <ResponsiveContainer width="100%" height={300}>
                <LineChart data={trendData}>
                  ...
                  />
                  <Legend />
                  <Line type="monotone" dataKey="활성" stroke="#00ff87" strokeWidth={3} dot={{ fill: '#00ff87', strokeWidth: 0 }} />
                </LineChart>
              </ResponsiveContainer>
            </div>
              ...
              <div className="chart-card full-width">
                ...
                <ResponsiveContainer width="100%" height={300}>
                  <LineChart data={dailyChangeData}>
                    ...
                    />
                    <Legend />
                    <Line type="monotone" dataKey="신규" stroke="#00d4ff" strokeWidth={3} dot={{ fill: '#00d4ff', strokeWidth: 0 }} />
                    <Line type="monotone" dataKey="만료" stroke="#ffaa00" strokeWidth={3} dot={{ fill: '#ffaa00', strokeWidth: 0 }} />
                  </LineChart>
                </ResponsiveContainer>
              </div>
            )}
      ...
      {activeTab === 'map' && (
        <div className="map-tab">
          ...
          <NotamMap notams={allNotams} focusNotam={selectedNotam} onFocusComplete={() => setSelectedNotam(null)} />
        </div>
      )}
