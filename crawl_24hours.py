...
def main():
    ...
    try:
        # 24시간 데이터 크롤링
        print("\n[1] 국내 NOTAM 크롤링 (24시간)...")
        domestic_result = crawler.crawl_notam_api('domestic', hours_back=24)
        ...
        print(f"  - 시간: {domestic_result.get('execution_time', 0):.2f}초")

        print("\n[2] 국제 NOTAM 크롤링 (24시간)...")
        international_result = crawler.crawl_notam_api('international', hours_back=24)
        ...
        print(f"  - 시간: {international_result.get('execution_time', 0):.2f}초")
